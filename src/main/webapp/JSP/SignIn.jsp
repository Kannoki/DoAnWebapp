...
<html>
  <head>
      ...
      <link rel="stylesheet" href="./lg-sg.css/lg-sg-css.css">
  ...
  <header class="p-3 bg_head text-white">
      <div class="container d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start bg-head">
          ...
          <a href="../index.html"><img src="Logo.svg" width="40px" height="40px" alt=""></a>

          <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
              <li><a href="../index.html  " class="nav-link px-2 text-black">Trang Chủ</a></li>
              <li>
                  <div class="dropdown">
          ...
          <div class="text-end">
              <a href="logIn.html"> <button type="button" class="btn btn-outline-light me-2">Đăng
                      nhập</button></a>
          </div>
      </div>
                  ...
                  <div class="box">
                      ...
                      <div>
                          ...
                          <form action="">
                              ...
                              <input type="text" class="text-field" placeholder="Nhập mail">
                          </form>
                          ...
                          <form action="">
                              <input type="password" class="text-field" placeholder="Nhập lại mật khẩu.">
                          </form>

                          <form action="" class="log_l">
                              <button class="btn" style="    background-color: #408cff; color:#ffffff">Đăng kí.</button>
